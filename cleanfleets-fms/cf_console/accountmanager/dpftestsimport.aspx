<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CF_Console.Master" CodeBehind="dpftestsimport.aspx.vb" Inherits="cleanfleets_fms.dpftestsimport" %>
<asp:Content runat="server" ContentPlaceHolderID="RightColumnContentPlaceHolder">
	...
	<div id="dvSectionImport" runat="server">
		<h1>Import Opacity Tests</h1>
		<div id="dvImportFile" runat="server">
			<p>
				Imports vehicle information from DPF Forms from a specially formatted Text File (.TXT).
			</p>
			<p>
				If the "Attach to Vehicle" option is set to Yes or left blank and an Opacity Test already exists with the Vehicle and Test Date, the existing Opacity Test will be updated.
			</p>
            <p>
			...
			<table ID="tblImportFile" runat="server" cellpadding="0" cellspacing="0" class="style1">
				<tr>
					...
					<td style="padding:3px" align="left">
						<asp:FileUpload ID="fu_ImportFile" runat="server" accept="text/plain" />
						<asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="fu_ImportFile"
							ErrorMessage="Please choose a Text file to import." />
					</td>
				</tr>
                <tr>
					<td class="tdtable" style="padding:3px" align="left">
