<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CF_Console.Master" CodeBehind="vehiclestransfer.aspx.vb" Inherits="cleanfleets_fms.vehiclestransfer1" %>
...
<asp:Content runat="server" ContentPlaceHolderID="RightColumnContentPlaceHolder">
	...
	<table id="table2" cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
			...
			<td>
				<asp:DropDownList ID="ddl_Account" runat="server" DataSourceID="sds_Account" DataTextField="AccountName"
		...
		<tr>
			...
			<td>
				<asp:DropDownList ID="ddl_Fleet" runat="server" DataSourceID="sds_Fleet" DataTextField="FleetName"
					DataValueField="IDProfileFleet" AutoPostBack="True">
				</asp:DropDownList>
			</td>
		</tr>
		<tr>
	...
	<asp:SqlDataSource ID="sds_CFV_Vehicles" runat="server" ConnectionString="<%$ ConnectionStrings:CF_SQL_Connection %>"
    	...
    	<asp:SqlDataSource ID="sds_Account" runat="server" ConnectionString="<%$ ConnectionStrings:CF_SQL_Connection %>"
