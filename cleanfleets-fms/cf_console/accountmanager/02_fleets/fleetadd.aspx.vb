...
Public Class fleetadd1
    ...
    Protected Sub btnInsert_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnInsert.Click
        ...
        strsqlinsert += "IDModifiedUser,IDRuleCode,EnterDate,ModifiedDate,IDProfileTerminal,FleetName,Address1,Address2,City,State,Zip,Telephone1,Ext1,Telephone2,Ext2,Telephone3,Ext3,Fax1,Email,Notes,NotesCF"
        strsqlinsert += ")"
        strsqlinsert += " values ("
        strsqlinsert += "@IDModifiedUser,@IDRuleCode,@EnterDate,@ModifiedDate,@IDProfileTerminal,@FleetName,@Address1,@Address2,@City,@State,@Zip,@Telephone1,@Ext1,@Telephone2,@Ext2,@Telephone3,@Ext3,@Fax1,@Email,@Notes,@NotesCF"
        strsqlinsert += ")"
