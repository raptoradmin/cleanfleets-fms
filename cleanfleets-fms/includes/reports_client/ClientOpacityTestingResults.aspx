<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CF_Client.Master" CodeBehind="ClientOpacityTestingResults.aspx.vb" Inherits="cleanfleets_fms.ClientOpacityTestingResults" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="RightColumnContentPlaceHolder" Runat="Server">
	...
	<div>
		<p>Include most recent Test Results collected within the specified date range. Leave blank to include the most recent Test Results.</p>
...
<%--        <div style="width:275px;display:inline-block">
        ...
        <asp:Label runat="server" ID="useridlabel"></asp:Label></div>--%>
