<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CF_Console.Master" CodeBehind="vehiclesadd.aspx.vb" Inherits="cleanfleets_fms.vehiclesadd1" %>
...
<asp:Content runat="server" ContentPlaceHolderID="RightColumnContentPlaceHolder">
	...
	<table style="width: 800px;">
		<tr>
			<td class="inputTitle" style="width: 125px;">
				Fleet Name:
			</td>
			<td>
				<p>
	...
	<table style="width: 100%">
		<tr>
			...
			<td style="width: 165px; text-align: right; font-weight: bold; color: #2C7500; font-size: small;">
	...
	<table style="width: 100%" id="datesTable">
		<tr>
			<td class="inputTitle" style="width: 175px;">
...
<EnabledStyle HorizontalAlign="Center"></EnabledStyle>
			...
			<td class="inputTitle" style="width: 160px;">
