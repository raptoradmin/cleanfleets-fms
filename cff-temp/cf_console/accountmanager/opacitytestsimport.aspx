<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CF_Console.Master" CodeBehind="opacitytestsimport.aspx.vb" Inherits="cleanfleets_fms.opacitytestsimport" %>
<asp:Content runat="server" ContentPlaceHolderID="RightColumnContentPlaceHolder">
	...
	<div id="dvSectionImport" runat="server">
		...
		<div id="dvImportFile" runat="server">
			<p>
				Imports Opacity Tests from a specially formatted Text File (.TXT).
			</p>
			<p>
