...
{
    public partial class CfProfileFleet
    {
        public CfProfileFleet()
        {
            CfVehicles = new HashSet<CfVehicles>();
        }
        ...
        public CfProfileTerminal IdprofileTerminalNavigation { get; set; }
        public ICollection<CfVehicles> CfVehicles { get; set; }
    }
}
