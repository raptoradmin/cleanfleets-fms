...
{
    public partial class CfVehicles
    {
        public CfVehicles()
        {
            CfEngines = new HashSet<CfEngines>();
        }
        ...
        public CfProfileFleet IdprofileFleetNavigation { get; set; }
        public ICollection<CfEngines> CfEngines { get; set; }
    }
}
