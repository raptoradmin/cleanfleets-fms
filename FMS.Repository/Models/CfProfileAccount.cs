...
{
    public partial class CfProfileAccount
    {
        public CfProfileAccount()
        {
            CfProfileTerminal = new HashSet<CfProfileTerminal>();
        }
        ...
        public ICollection<CfProfileTerminal> CfProfileTerminal { get; set; }
    }
}
