<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CF_Console.Master" CodeBehind="account_user_add.aspx.vb" Inherits="cleanfleets_fms.account_user_add" %>
...
<asp:Content runat="server" ContentPlaceHolderID="RightColumnContentPlaceHolder">
												...
												<tr>
													<td style="width: 50%">
														<asp:DropDownList id="Permissions" runat="server"
														 ...
														 <asp:ListItem Text="--Choose One--" Value="G" />
													</asp:DropDownList>
					...
					<ContentTemplate>
						<table border="0">
							...
							<tr>
								...
								<td>
									<asp:HiddenField ID="hdf_IDProfileAccount" runat="server" />
								</td>
							</tr>
							<tr>
								<td align="right" style="font-size: small; font-weight: bold; text-align: right;
								...
								<td>
									<b><span style="font-size: medium; color: #2C7500">
										<asp:DropDownList ID="ddl_IDClientAccessLevel" runat="server" AppendDataBoundItems="True"
											DataSourceID="sds_CF_Option_List_ClientAccessLevel" DataTextField="DisplayValue"
							...
							<tr>
								...
								<td>
									<b><span style="font-size: medium; color: #2C7500">
										<asp:DropDownList ID="ddl_IDContactTitle" runat="server" AppendDataBoundItems="True"
											DataSourceID="sds_CF_Option_List_Contact_Title" DataTextField="DisplayValue"
											DataValueField="IDOptionList" TabIndex="5">
											<asp:ListItem Text="Select" Value="" />
										</asp:DropDownList>
									</span></b>
	...
	<asp:SqlDataSource ID="sds_CF_Option_List_Contact_Title" runat="server" ConnectionString="<%$ ConnectionStrings:CF_SQL_Connection %>"
	...
	<asp:SqlDataSource ID="sds_CF_Option_List_ClientAccessLevel" runat="server" ConnectionString="<%$ ConnectionStrings:CF_SQL_Connection %>"
		SelectCommand="SELECT [IDOptionList], [RecordValue], [DisplayValue], [OptionName] FROM [CF_Option_List] WHERE ([OptionName] = @OptionName)">
		<SelectParameters>
			<asp:Parameter DefaultValue="ClientAccessLevel" Name="OptionName" Type="String" />
		</SelectParameters>
	</asp:SqlDataSource>
	...
	<asp:SqlDataSource ID="sds_Profile_Terminal" runat="server" ConnectionString="<%$ ConnectionStrings:CF_SQL_Connection %>"
		SelectCommand="GetAccountTerminals" SelectCommandType="StoredProcedure">
		<SelectParameters>
