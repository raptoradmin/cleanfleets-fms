...
<ItemStyle CssClass="radgrid" Width="50px"></ItemStyle>
	...
	<asp:SqlDataSource ID="sds_Account_Profile" runat="server" ConnectionString="<%$ ConnectionStrings:CF_SQL_Connection %>"
		SelectCommand="SELECT [IDProfileAccount], [AccountName], CAST(Telephone1 AS bigint)as Telephone1, [Ext1], [Email], [WebSite] FROM [CF_Profile_Account] ORDER BY [AccountName]">
	</asp:SqlDataSource>
</asp:Content>
