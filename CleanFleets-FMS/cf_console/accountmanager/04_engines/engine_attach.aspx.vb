...
Public Class engine_attach1
    ...
    Protected Sub btn_Attach_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Attach.Click
        ...
        Dim IDEngine As String = ddl_IDEngines.SelectedValue
        ...
        sql = "UPDATE CF_Engines SET IDVehicles = @IDVehicles WHERE IDEngines = @IDEngines"
