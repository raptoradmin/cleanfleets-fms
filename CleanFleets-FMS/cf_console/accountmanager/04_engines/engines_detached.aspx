<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CF_Console.Master" CodeBehind="engines_detached.aspx.vb" Inherits="cleanfleets_fms.engines_detached1" %>
                                        ...
                                        <table style="width: 661px">
                                            <tr>
                                                ...
                                                <td style="width: 135px;">
                                                    <telerik:RadComboBox ID="RadComboBox1" Runat="server" AllowCustomText="True" DataSourceID="sds_ddl_Op_EngineModel" DataTextField="EngineModel" DataValueField="EngineModel" EmptyMessage="Select" Skin="Forest" Text='<%# Bind("EngineModel") %>' Width="150px">
                                                    </telerik:RadComboBox>
                                                </td>
                                                </td>
