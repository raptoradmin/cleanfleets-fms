...
<asp:Content runat="server" ContentPlaceHolderID="RightColumnContentPlaceHolder">
    ...
    <asp:textbox id="qsinspection" runat="server" Visible="false" />
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <%--<p>
                                                            ...
                                                            <%--Added by Andrew on 12/5/2019 for formatting purposes to make the display look more pleasing.--%>
                                                            <br />
                                                            <br />
                                                            <%--End of what was added by Andrew on 12/5/2019.--%>
                                                            <p>
                ...
                <td>
                    <asp:FormView ID="fv_CFV_DPF" runat="server" CellPadding="5" 
                        ...
                        <EditItemTemplate>
                            ...
                            <%--Commenting out parts of Vehicle section and moving Miles and Hours under Wire Test Results; done by Andrew on 12/5/2019.--%>
                            <table>
                                <%--<tr>
									<td style="width: 125px; " class="tdtable">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 102px;">
                                        <asp:TextBox ID="CompanyTextBox" runat="server" Visible="false" Text='<%# Bind("Company") %>' Width="75px" />
                                    </td>
                                    <%--<td style="width: 83px; " class="tdtable">
                                        VIN #: </td>--%>
                                    <td style="width: 190px" colspan="3">
                                        <asp:TextBox ID="VINNoTestBox" runat="server" Visible="false" Text='<%# Bind("VINNumber") %>' />
                                    </td>
                                   <%--<td style="width: 83px; " class="tdtable">
                                        Make: </td>--%>
                                    <td style="width: 190px" colspan="3">
                                        <asp:TextBox ID="MakeTextBox" runat="server" Visible="false" Text='<%# Bind("Make") %>' />
                                    </td>
                                </tr>
                                 <tr>
                                    <%--<td style="width: 90px; " class="tdtable">
                                    ...
                                    <td style="width: 102px;">
                                        <asp:TextBox ID="ModelTextBox" runat="server" Visible="false" Text='<%# Bind("Model") %>' Width="75px" />
                                    </td>
                                    <%--<td style="width: 83px; " class="tdtable">
                                        Plate No: </td>--%>
                                    <td style="width: 190px" colspan="2">
                                        <asp:TextBox ID="PlateTextBox" runat="server" Visible="false" Text='<%# Bind("Plate") %>' />
                                    </td>
                                   <%--<td style="width: 83px; " class="tdtable">
                                        Miles: </td>--%>
                                    <%--<td style="width: 190px" colspan="2">
                                        <asp:TextBox ID="MilesTextBox" runat="server" Visible="false" Text='<%# Bind("Miles") %>' />
                                    </td>--%>
                                      <%--<td style="width: 83px; " class="tdtable">
                                        Hours: </td>--%>
                                    <%--<td style="width: 190px" colspan="2">
                                        <asp:TextBox ID="HoursTextBox" runat="server" Visible="false" Text='<%# Bind("Hours") %>' />
                                    </td>--%>
                                </tr>
								<tr><td colspan="6">
                           ...
                           <table cellpadding="0" cellspacing="0" style="width: 100%">
                            ...
                            <table border="1">
                                ...
                                <%--Inserting the Miles and Hours from Vehicle section here; done by Andrew on 12/5/2019.--%>
                                <tr>
                                    <td style="width: 83px; " class="tdtable">
                                        Miles: </td>
                                    <td style="width: 190px" colspan="2">
                                ...
                                <%--End of content that was inserted on 12/5/2019.--%>
                                <tr>
									<td style="width: 175px; " class="tdtable">
                                        Cleaning Tech:</td>
                                    <td style="width: 130px">
                          ...
                          <table style="width: 100%">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 102px;">
                                        <asp:Label ID="lbl_Company" runat="server" Visible="false" Text='<%# Bind("Company") %>' />
                                    </td>
                                    <%--<td style="width: 83px; " class="tdtable">
                                        VIN #: </td>--%>
                                    <td style="width: 190px" colspan="3">
                            ...
                            <table border="1">
                                ...
                                <%--The moved section is shown below; moved from Vehicle section on 12/5/2019 by Andrew.--%>
                                <tr>
                                    <td style="width: 83px; " class="tdtable">
                                        Miles: </td>
                                    <td style="width: 190px" colspan="3">
                                ...
                                <%--End of what was moved by Andrew on 12/5/2019.--%>
                                <tr>
									<td style="width: 175px; " class="tdtable">
                                        Cleaning Tech:</td>
                                    <td style="width: 130px">
