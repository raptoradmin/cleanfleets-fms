<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CF_Console.Master" CodeBehind="DECsadd.aspx.vb" Inherits="cleanfleets_fms.DECsadd1" %>
...
<DateInput DisplayDateFormat="M/d/yyyy" DateFormat="M/d/yyyy" SelectedDate="2000-01-01"></DateInput>
	...
	<p>
		...
		<asp:Button ID="btnCancel" runat="server" TabIndex="20" Text="Cancel" CausesValidation="false" />
	</p>
