<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CF_Console.Master" CodeBehind="05_vehicles_detailed.aspx.vb" Inherits="cleanfleets_fms._05_vehicles_detailed1" %>
...
<asp:Content runat="server" ContentPlaceHolderID="RightColumnContentPlaceHolder">
	...
	<telerik:radgrid id="rg_Terminals" datasourceid="sds_Vehicles" allowsorting="True"
        ...
        <MasterTableView Width="100%" CommandItemDisplay="Top" AutoGenerateColumns="False" 
            ...
            <Columns>
				...
				<telerik:GridBoundColumn DataField="ComplianceCertCount" DefaultInsertValue="" 
					HeaderText="Number of Compliance Certificate Files" SortExpression="ComplianceCertCount" UniqueName="ComplianceCertCount">
				</telerik:GridBoundColumn>
				<telerik:GridBoundColumn DataField="FleetSummaryCount" DefaultInsertValue="" 
					HeaderText="Number of Fleet Summary Files" SortExpression="FleetSummaryCount" UniqueName="FleetSummaryCount">
				</telerik:GridBoundColumn>
				...
				<telerik:GridBoundColumn DataField="UnspecifiedFileCount" DefaultInsertValue="" 
					HeaderText="Number of unspecified files" SortExpression="UnspecifiedFileCount" UniqueName="UnspecifiedFileCount">
				</telerik:GridBoundColumn>
	...
	<%-- <asp:SqlDataSource ID="sds_Vehicles" runat="server" ConnectionString="<%$ ConnectionStrings:CF_SQL_Connection %>"
		SelectCommand="SELECT * FROM [CFV_Report_Vehicles_Details] WHERE ([IDProfileFleet] = @IDProfileFleet)">
		<SelectParameters>
