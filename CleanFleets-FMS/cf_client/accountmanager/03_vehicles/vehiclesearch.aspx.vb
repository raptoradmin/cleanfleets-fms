...
Public Class vehiclesearch
    ...
    Protected Sub radgrid1_DataBound(ByVal sender As Object, ByVal e As EventArgs) Handles RadGrid1.Databound
        ...
        Dim doAutoredirect As Boolean = False
        doAutoredirect = Request.QueryString("AutoRedirect") = "" OrElse Request.QueryString("AutoRedirect") = "true"
        If doAutoredirect Then
            If items IsNot Nothing AndAlso items.Count = 1 AndAlso RadGrid1.CurrentPageIndex = 0 Then
