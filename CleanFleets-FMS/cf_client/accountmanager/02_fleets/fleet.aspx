<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CF_Client.Master" CodeBehind="fleet.aspx.vb" Inherits="cleanfleets_fms.fleet" %>
<asp:Content runat="server" ContentPlaceHolderID="RightColumnContentPlaceHolder">
	...
	<telerik:radgrid id="RadGrid1" runat="server" datasourceid="sds_Profile_Fleet" gridlines="None"
		skin="Telerik" width="780px" allowsorting="True" cssclass="radgrid">
	...
	<br />
	<!--09/13/2012 IR: Show the add fleet button when the current user has read/write permissions on the terminal -->
	...
	<asp:SqlDataSource ID="sds_Profile_Fleet" runat="server" ConnectionString="<%$ ConnectionStrings:CF_SQL_Connection %>"
		SelectCommand="SELECT [IDProfileAccount], [IDProfileFleet], [IDProfileTerminal], [FleetName], [City], CAST(Telephone1 AS bigint)as Telephone1, [Ext1],  [City] FROM [CFV_Profile_Fleet] WHERE ([IDProfileTerminal] = @IDProfileTerminal)">
		<SelectParameters>
			<asp:QueryStringParameter Name="IDProfileTerminal" QueryStringField="IDProfileTerminal"
				Type="Int32" />
		</SelectParameters>
